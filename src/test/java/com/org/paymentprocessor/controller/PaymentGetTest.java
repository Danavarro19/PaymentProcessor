...
class PaymentGetTest {
    ...
    void shouldReturnAllPaymentsWhenFiltersAreMissing() {
        when(paymentService.getPayments(null, null, null))
        ...
        PaymentResponse payment = response.getBody()[0];

        assertThat(payment.getId()).isEqualTo("PAY-1001");
        assertThat(payment.getCustomerId()).isEqualTo("CUST-10");
        ...
        verify(paymentService).getPayments(null, null, null);
    }
    ...
    void shouldPassFiltersToPaymentService() {
        ...
        when(paymentService.getPayments("CUST-10", from, to))
                .thenReturn(List.of(paymentResponse()));
    ...
    void shouldReturnBadRequestForInvalidDateRange() {
        ...
        when(paymentService.getPayments(null, from, to))
                .thenThrow(
